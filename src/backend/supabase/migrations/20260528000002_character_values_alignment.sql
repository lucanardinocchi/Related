-- Replace relationship-based values alignment with character-based alignment.
-- Migration 20260528000001 was applied remotely with the prior schema; this
-- migration brings hosted DB in line with the Values Discovery character roster.

drop table if exists public.relationship_values_alignment;
drop table if exists public.user_character_values_alignment;
