...
//
// ADR-0010 dual-write lives in src/shared/src/signals/calendarSyncDualWrite.ts
// (inferred_signal_calendar + events). This function handles OAuth fetch only.
//
...
// dual-writes via persistCalendarSyncSnapshot.
//
...
import { persistCalendarSyncSnapshot } from "../../../../shared/src/signals/calendarSyncDualWrite.ts";
